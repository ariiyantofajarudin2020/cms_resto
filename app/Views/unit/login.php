                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class=" py-4">
                                <a href="<?= base_url('/u/' . $wc) ?>"
                                    class="logo d-flex align-items-center w-auto text-centerd-flex justify-content-center">
                                    <img src="<?= base_url('assets/img/logo.png') ?>" alt="">
                                    <span class="d-none d-lg-block">Unit Aplikasi</span>
                                </a>

                                <a href="<?= base_url('/u/' . $wc) ?>" class="logo text-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Halaman Masuk
                                        </h5>
                                    </div>

                                    <form class="row g-3 needs-validation" method="post"
                                        action="<?= base_url('/unit/auth') ?>">
                                        <input type="hidden" name="wildcard" value="<?= $wc ?>" class="form-control">

                                        <div class="col-12">
                                            <label for="yourUsername" class="form-label">Username</label>
                                            <div class="input-group has-validation">
                                                <input type="text" name="username" class="form-control"
                                                    id="yourUsername" required placeholder="Masukkan Username">
