            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            <h4 class="card-title">Master Service Charge (%)</h4>
                            <form action="<?= base_url('/unit/post/up_master_sc') ?>" method="post"
                                onsubmit="return simpann()">
                                <input type="hidden" name="wc" value="<?=$wc?>">
                                <input type="hidden" name="id_induk" value="<?=$induk['id_induk']?>">
                                <div class="row">
                                    <div class="col-4">
                                        <input type="number" name="sc" id="sc" value="<?=$pos['sc']?>" disabled>
                                        <br><br>
...
function btn_batal() {
    document.getElementById('sc').value = '<?=$pos['sc']?>';
