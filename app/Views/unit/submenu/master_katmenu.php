            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            <h4 class="card-title">Master Kategori Menu</h4>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    function lihat<?=$key?>() {
                                        disabledform();
                                        document.getElementById('unique_old').value = '<?=$u["menu_kategori"]?>';
                                        document.getElementById('nama').value = '<?=$u["menu_kategori"]?>';
                                        document.getElementById('mode').value = 'lihat';
                                        document.getElementById('id_katmenu').value = '<?=$u["id_menu_kategori"]?>';
                                        document.getElementById('judul').innerHTML = 'Detail info kategori menu';
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="pt-12 pb-2">
                                <h5 id="judul" class="card-title text-center pb-0 fs-4">Detail info kategori menu</h5>
                            </div>
                            <form class="row g-3 needs-validation" novalidate
                                action="<?= base_url('/unit/post/up_katmenu') ?>" enctype="multipart/form-data"
                                method="post">
                                <input type="hidden" name="id_induk" value="<?= $induk['id_induk'] ?>">
                                <input type="hidden" name="wc" value="<?= $wc ?>">
                                <input id="id_katmenu" type="hidden" name="id_katmenu">
                                <input id="mode" type="hidden" name="mode">
                                <input id="unique_old" type="hidden" name="unique_old">

                                <div class="col-6">
                                    <label for="nama" class="form-label">Nama Kategori</label>
                                    <input type="text" name="menu_kategori" class="form-control" id="nama" disabled
                                        required>
                                ...
                                <div class="col-12">
                                    ...
                                    function tambah() {
                                        ...
                                        document.getElementById('id_katmenu').value = '';
                                        document.getElementById('judul').innerHTML = 'Tambah kategori menu baru';
                                    ...
                                    function edit() {
                                        ...
                                        document.getElementById('judul').innerHTML = 'Ubah data kategori menu';
                                        document.getElementById('btn_tambah').style.display = 'none';
                                        document.getElementById('btn_simpan').style.display = '';
                                        document.getElementById('btn_edit').style.display = 'none';
                                        document.getElementById('btn_batal').style.display = '';
