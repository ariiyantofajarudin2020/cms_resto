            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            <h4 class="card-title">Master Jenis Tipe Transaksi</h4>
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    function lihat<?=$key?>() {
                                        disabledform();
                                        document.getElementById('unique_old').value = '<?=$u["type_trans"]?>';
                                        document.getElementById('nama').value = '<?=$u["type_trans"]?>';
                                        document.getElementById('mode').value = 'lihat';
                                        document.getElementById('id_tiptrans').value = '<?=$u["id_typetrans"]?>';
                                        document.getElementById('judul').innerHTML = 'Detail info tipe transaksi';
                    ...
                    <div class="card info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="pt-12 pb-2">
                                <h5 id="judul" class="card-title text-center pb-0 fs-4">Detail info Tipe Transaksi</h5>
                            </div>
                            <form class="row g-3 needs-validation" novalidate
                                action="<?= base_url('/unit/post/up_tiptrans') ?>" enctype="multipart/form-data"
                                method="post">
                                <input type="hidden" name="id_induk" value="<?= $induk['id_induk'] ?>">
                                <input type="hidden" name="wc" value="<?= $wc ?>">
                                <input id="id_tiptrans" type="hidden" name="id_tiptrans">
                                <input id="mode" type="hidden" name="mode">
                                <input id="unique_old" type="hidden" name="unique_old">

                                <div class="col-6">
                                    <label for="nama" class="form-label">Nama tipe transaksi</label>
                                    <input type="text" name="tiptrans_nama" class="form-control" id="nama" disabled
                                        required>
                                ...
                                <div class="col-12">
                                    ...
                                    function tambah() {
                                        ...
                                        document.getElementById('id_tiptrans').value = '';
                                        document.getElementById('judul').innerHTML = 'Tambah tipe transaksi baru';
                                    ...
                                    function edit() {
                                        ...
                                        document.getElementById('judul').innerHTML = 'Ubah data tipe transaksi';
                                        document.getElementById('btn_tambah').style.display = 'none';
                                        document.getElementById('btn_simpan').style.display = '';
                                        document.getElementById('btn_edit').style.display = 'none';
                                        document.getElementById('btn_batal').style.display = '';
